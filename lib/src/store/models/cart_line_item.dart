...
class CartLineItem {
  ...
  List<Map<String?, dynamic>>? appMetaData,
    ...
    isManagedStock: isManagedStock ?? this.isManagedStock,
    stockQuantity: stockQuantity ?? this.stockQuantity,
    shippingClassId: shippingClassId ?? this.shippingClassId,
    taxStatus: taxStatus ?? this.taxStatus,
    taxClass: taxClass ?? this.taxClass,
    shippingIsTaxable: shippingIsTaxable ?? this.shippingIsTaxable,
  ...
  CartLineItem.fromProduct(
    ...
    imageSrc = product.images.isEmpty
        ? env.product_placeholder_image //env.product_placeholder_image
  ...
  CartLineItem.fromProductVariation(
    ...
    String? imageSrc = env.product_placeholder_image;
