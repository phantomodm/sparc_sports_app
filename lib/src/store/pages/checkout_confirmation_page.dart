...
import 'package:collection/collection.dart' as it;
...
import 'package:sparc_sports_app/src/store/widgets/checkout_coupon_amount_widget.dart';
import 'package:sparc_sports_app/src/store/widgets/checkout_payment_type_widget.dart';
import 'package:sparc_sports_app/src/store/widgets/checkout_select_coupon_widget.dart';
import 'package:sparc_sports_app/src/store/widgets/checkout_shipping_type_widget.dart';
import 'package:sparc_sports_app/src/store/widgets/checkout_store_heading_widget.dart';
import 'package:sparc_sports_app/src/store/widgets/checkout_user_details_widget.dart';
...
class CheckoutConfirmationPageState
    extends SparcState<CheckoutConfirmationPage> {
  CheckoutConfirmationPageState();
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  "${appTranslations.trans(context, "One moment")}...",
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text(appTranslations.trans(context, "Checkout")),
        ...
        child: ListView(
          ...
          children: <Widget>[
            ListView(
              ...
              children: [
                const CheckoutStoreHeadingWidget(),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          CheckoutSubtotal(
                            title: appTranslations.trans(context, "Subtotal"),
                          ),
                          ...
                          Padding(
                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  text:
                                      '${appTranslations.trans(context, 'By completing this order, I agree to all')} ',
                ...
                children: [
                  ...
                  PrimaryButton(
                    title: _isProcessingPayment
                        ? "${appTranslations.trans(context, "PROCESSING")}..."
                        : appTranslations.trans(context, "CHECKOUT"),
      ...
      if (doubleTotal < doubleMinimumValue) {
        if (mounted) {
          ToastHelper().showToastNotification(context,
              ...
              description:
                  "${appTranslations.trans(context, "Spend a minimum of")} ${formatDoubleCurrency(total: doubleMinimumValue)} ${appTranslations.trans(context, "for")} ${checkoutSession.shippingType!.getTitle()}",
