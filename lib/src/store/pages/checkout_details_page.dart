...
import 'package:sparc_sports_app/src/store/widgets/customer_address_input.dart';
import 'package:sparc_sports_app/src/store/widgets/safearea_widget.dart';
import 'package:sparc_sports_app/src/store/widgets/switch_address_tab.dart';
...
class _CheckoutDetailsPageState extends SparcState<CheckoutDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          appTranslations.trans(context, "Billing & Shipping Details"),
        ),
        centerTitle: true,
      ),
      body: SafeAreaWidget(
                                ...
                                children: <Widget>[
                                  Padding(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        SwitchAddressTab(
                                            title: appTranslations.trans(context, "Billing Details"),
                                        ...
                                        SwitchAddressTab(
                                            title: appTranslations.trans(context, "Shipping Address"),
                                            currentTabIndex: activeTabIndex,
                                            type: "shipping",
                                            onTapAction: () => setState(() {
                                                  activeTabIndex = 1;
                      ...
                      child: Column(
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              Text(
                                appTranslations.trans(context, "Ship to a different address?"),
                          ...
                          if (_wpLoginEnabled == true)
                            Row(
                              ...
                              children: <Widget>[
                                Text(
                                  appTranslations.trans(context, "Remember my details"),
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                                Checkbox(
                          ...
                          PrimaryButton(
                            title: appTranslations.trans(context, "USE DETAILS"),
    ...
    await lockRelease('update_shipping', perform: () async {
      ...
      if (billingEmail.isEmpty || !validate.isEmail(billingEmail)) {
        ToastHelper().showToastNotification(
          context,
          title: appTranslations.trans(context, "Oops"),
          description: appTranslations.trans(context, "Please enter a valid billing email"),
          style: ToastNotificationStyleType.WARNING,
        );
        return;
      }
      ...
      if (shippingEmail.isNotEmpty && !validate.isEmail(shippingEmail)) {
       ToastHelper().showToastNotification(
          context,
          title: appTranslations.trans(context, "Oops"),
          description: appTranslations.trans(context, "Please enter a valid shipping email"),
          style: ToastNotificationStyleType.WARNING,
        );
        return;
      }
      ...
      if (_wpLoginEnabled == true) {
        ...
        try {
          await WPJsonAPI.instance.api(
            (request) => request.wpUpdateUserInfo(userToken: userToken, metaData: [
    ...
    await lockRelease('load_shipping_info', perform: () async {
      ...
      try {
        wpUserInfoResponse = await WPJsonAPI.instance
            .api((request) => request.wpGetUserInfo(userToken:userToken!));
      } on Exception catch (e) {
        print(e.toString());
       ToastHelper().showToastNotification(
          context,
