...
class _CheckoutShippingTypePageState extends State<CheckoutShippingTypePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(appTranslations.trans(context,"Shipping Methods")),
                                                ...
                                                text: TextSpan(
                                                  ...
                                                  children: <TextSpan>[
                                                    (shippingOption["object"]
                                                            is FreeShipping
                                                        ? TextSpan(
                                                            text: appTranslations.trans(context,
                                                                "Free postage"),
                                                          )
                                                        : TextSpan(
                                                            text:
                                                                "${appTranslations.trans(context,"Price")}: ${formatStringCurrency(total: data.data)}",
                                                          )),
                                                    if (shippingOption[
                                                            "min_amount"] !=
                                                        null)
                                                      TextSpan(
                                                          text:
                                                              "\n${appTranslations.trans(context,"Spend a minimum of")} ${formatStringCurrency(total: shippingOption["min_amount"])}",
                                                          style:
                                                              Theme.of(context)
                                                                  .textTheme
                                                                  .bodyMedium!
